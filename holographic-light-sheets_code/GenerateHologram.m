%% This code calculates a phase-only computer generated hologram to accurately encode a target complex field profile
...
function [SLM0,Energy] =  GenerateHologram(Psi1,nx,ny,X,Y)
n_x = 1200;
n_y = 1200;
[n_y,n_x] = size(Psi1);
ph=angle(Psi1);
